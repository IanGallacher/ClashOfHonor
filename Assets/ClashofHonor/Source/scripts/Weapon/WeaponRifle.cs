...
//
//            //This is all commented out because I am using a custom camera rig. Come back to this for refrerence later. 
//
//            Vector3 pos;
//            Quaternion look;
//
...
//                    if (serializer)
//                    {
//                        if (serializer.state.team != state.team)
...
//
//
//                        var serializerNPC = hit.body.GetComponent<NPCController>();
//                        if (serializerNPC)
//                            serializerNPC.ApplyDamage(controller.activeWeapon.damagePerBullet);
//                    }
//                }
//            }
//        }
